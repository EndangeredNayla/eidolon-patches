...
public class EntityPage extends Page {
    ...
    public void render(CodexGui gui, PoseStack mStack, int x, int y, int mouseX, int mouseY) {
        ...
        MultiBufferSource.BufferSource bufferSource = Minecraft.getInstance().renderBuffers().bufferSource();        mStack.pushPose();
        ...
        renderer.render(e, e.getYRot(), 0, mStack, bufferSource, 0xf000f0);
